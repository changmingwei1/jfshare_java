package com.jfshare.seller.dao.redis;
...
public interface ISellerJedis {
	/**
	 * 添加在线用户
	 * @param tbSeller
	 * @param sId 服务器端用户标识
	 */
	int addOnline(TbSeller tbSeller, String sId);
	 ...
	 * @return
	 */
    TbSeller getOnlineBySID(String sId);
     ...
     * @return
     */
    TbSeller getOnlineByUID(String uId);
     ...
     * @return
     */
    List<TbSeller> getOnlinesByPage(int curPage, int pageSize);
	...
	/**
	 * 记录失败登陆信息
	 * @param tbSeller 用户登陆信息
	 * @return
	 */
	int addTryFail(TbSeller tbSeller);
