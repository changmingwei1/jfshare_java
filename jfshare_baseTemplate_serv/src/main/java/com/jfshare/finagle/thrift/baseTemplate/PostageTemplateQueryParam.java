...
public class PostageTemplateQueryParam implements TBase<PostageTemplateQueryParam, PostageTemplateQueryParam._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("PostageTemplateQueryParam");
  ...
  private static final TField IS_USED_FIELD_DESC = new TField("isUsed", TType.I32, (short)6);
  ...
  public PostageTemplateQueryParam() {
  }
   ...
   */
  public PostageTemplateQueryParam(PostageTemplateQueryParam other) {
  ...
  public PostageTemplateQueryParam deepCopy() {
    return new PostageTemplateQueryParam(this);
  }
  ...
  public PostageTemplateQueryParam setId(int id) {
    this.id = id;
    setIdIsSet(true);
  ...
  public PostageTemplateQueryParam setSellerId(int sellerId) {
    this.sellerId = sellerId;
    setSellerIdIsSet(true);
  ...
  public PostageTemplateQueryParam setType(int type) {
    this.type = type;
    setTypeIsSet(true);
  ...
  public PostageTemplateQueryParam setName(String name) {
    this.name = name;
  ...
  public PostageTemplateQueryParam setIsUsed(int isUsed) {
    this.isUsed = isUsed;
    setIsUsedIsSet(true);
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PostageTemplateQueryParam)
      return this.equals((PostageTemplateQueryParam)that);
    return false;
  }

  public boolean equals(PostageTemplateQueryParam that) {
    if (that == null)
      return false;
  ...
  public int compareTo(PostageTemplateQueryParam other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    PostageTemplateQueryParam typedOther = (PostageTemplateQueryParam)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PostageTemplateQueryParam(");
    boolean first = true;
    sb.append("id:");
    sb.append(this.id);
    first = false;
