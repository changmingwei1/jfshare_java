...
public class StockResult implements TBase<StockResult, StockResult._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("StockResult");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(StockResult.class, metaDataMap);
  }
   ...
   */
  public StockResult(StockResult other) {
  ...
  public StockResult setResult(com.jfshare.finagle.thrift.result.Result result) {
    this.result = result;
  ...
  public StockResult setStockInfo(StockInfo stockInfo) {
    this.stockInfo = stockInfo;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StockResult)
      return this.equals((StockResult)that);
    return false;
  }

  public boolean equals(StockResult that) {
    if (that == null)
      return false;
  ...
  public int compareTo(StockResult other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    StockResult typedOther = (StockResult)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StockResult(");
    boolean first = true;
    sb.append("result:");
    if (this.result == null) {
      sb.append("null");
