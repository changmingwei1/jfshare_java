package com.jfshare.address.aop;
...
@Aspect
@Component
public class AddressLoggerAop {
    private Logger logger = LoggerFactory.getLogger(AddressLoggerAop.class);
    ...
    public Object doLogAndTimer(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            logger.info(mtdName + "   responseTime:" + (endTime - startTime) + "...");
        }
    }
