...
public class WeixinConfig {
    ...
    // 商户的私钥
    public static String key = "esvlhExwkEjICItRmHJqwP65ohRrFeJR"; //old g3Qivc5P9zaGy81FR2slqb03r2Xgx6HY
    // 签名方式 不需修改
    public static String sign_type = "MD5";
    //公众账号ID
    public static String appid = "wx8431024cc21de418"; //old wxd20631014da48053
    //商户号
    public static String mch_id = "10011931"; //old 1241526502
    //支付网关
