...
public interface TbOrderInfoRecordMapper {
    ...
    @Insert({
        ...
        "#{thirdexchangerate,jdbcType=VARCHAR}, #{weight,jdbcType=VARCHAR}, ",
        "#{postageext,jdbcType=VARCHAR})"
    })
    ...
    @Select({
        ...
        "postage_template_id, storehouse_id, thirdExchangeRate, weight, postageExt",
