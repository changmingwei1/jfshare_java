...
public class AfterSaleOrderParam implements TBase<AfterSaleOrderParam, AfterSaleOrderParam._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("AfterSaleOrderParam");
  ...
  private static final TField START_TIME_FIELD_DESC = new TField("startTime", TType.STRING, (short)4);
  private static final TField END_TIME_FIELD_DESC = new TField("endTime", TType.STRING, (short)5);
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(AfterSaleOrderParam.class, metaDataMap);
  }


  public AfterSaleOrderParam() {
  }
   ...
   */
  public AfterSaleOrderParam(AfterSaleOrderParam other) {
  ...
  public AfterSaleOrderParam deepCopy() {
    return new AfterSaleOrderParam(this);
  }
  ...
  public AfterSaleOrderParam setUserId(int userId) {
    this.userId = userId;
    setUserIdIsSet(true);
  ...
  public AfterSaleOrderParam setOrderId(String orderId) {
    this.orderId = orderId;
  ...
  public AfterSaleOrderParam setSellerId(int sellerId) {
    this.sellerId = sellerId;
    setSellerIdIsSet(true);
  ...
  public AfterSaleOrderParam setStartTime(String startTime) {
    this.startTime = startTime;
  ...
  public AfterSaleOrderParam setEndTime(String endTime) {
    this.endTime = endTime;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AfterSaleOrderParam)
      return this.equals((AfterSaleOrderParam)that);
    return false;
  }

  public boolean equals(AfterSaleOrderParam that) {
    if (that == null)
      return false;
  ...
  public int compareTo(AfterSaleOrderParam other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    AfterSaleOrderParam typedOther = (AfterSaleOrderParam)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AfterSaleOrderParam(");
    boolean first = true;
    sb.append("userId:");
