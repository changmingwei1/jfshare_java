...
//    }
    ...
    public void testOrderProfileQueryOffline() throws Exception {
    	int userType = 2;////用户类型，1买家，2卖家，3系统
    	int userId = 4;////用户ID
        OrderQueryConditions queryConditions = new OrderQueryConditions();
        //queryConditions.setSellerId(4);
        queryConditions.setPayTimeStart("2016-7-01");
        queryConditions.setPayTimeEnd("2016-8-30");
        queryConditions.setCurPage(1);
        queryConditions.setCount(5);
        System.out.println(this.client.orderProfileQueryOffline(userType, userId, queryConditions));
    }
}
