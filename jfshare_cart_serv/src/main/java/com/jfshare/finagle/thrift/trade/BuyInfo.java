...
public class BuyInfo implements TBase<BuyInfo, BuyInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public com.jfshare.finagle.thrift.order.PayChannel payChannel;
  ...
  static {
    ...
    tmpMap.put(_Fields.PAY_CHANNEL, new FieldMetaData("payChannel", TFieldRequirementType.DEFAULT,
      new StructMetaData(TType.STRUCT, com.jfshare.finagle.thrift.order.PayChannel.class)));
  ...
  public BuyInfo(
    ...
    String userName,
    String amount,
    com.jfshare.finagle.thrift.order.PayChannel payChannel,
  ...
  public BuyInfo(BuyInfo other) {
    ...
    if (other.isSetPayChannel()) {
      this.payChannel = new com.jfshare.finagle.thrift.order.PayChannel(other.payChannel);
    }
  ...
  public com.jfshare.finagle.thrift.order.PayChannel getPayChannel() {
    return this.payChannel;
  }

  public BuyInfo setPayChannel(com.jfshare.finagle.thrift.order.PayChannel payChannel) {
    this.payChannel = payChannel;
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PAY_CHANNEL:
      if (value == null) {
        ...
        setPayChannel((com.jfshare.finagle.thrift.order.PayChannel)value);
      }
      break;
    case DELIVER_INFO:
      if (value == null) {
      ...
      switch (field.id) {
        ...
        case 4: // PAY_CHANNEL
          if (field.type == TType.STRUCT) {
            this.payChannel = new com.jfshare.finagle.thrift.order.PayChannel();
