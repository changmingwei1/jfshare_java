...
public class CartKey implements TBase<CartKey, CartKey._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("CartKey");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(CartKey.class, metaDataMap);
  }
  ...
  public CartKey deepCopy() {
    return new CartKey(this);
  }
  ...
  public CartKey setProductId(String productId) {
    this.productId = productId;
  ...
  public CartKey setSkuNum(String skuNum) {
    this.skuNum = skuNum;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CartKey)
      return this.equals((CartKey)that);
    return false;
  }

  public boolean equals(CartKey that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CartKey other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CartKey typedOther = (CartKey)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CartKey(");
    boolean first = true;
    sb.append("productId:");
    if (this.productId == null) {
      sb.append("null");
