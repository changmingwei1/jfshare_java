...
public class ScoreTradeQueryParam implements TBase<ScoreTradeQueryParam, ScoreTradeQueryParam._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField TRADE_TIME_FIELD_DESC = new TField("tradeTime", TType.STRING, (short)2);
  private static final TField IN_OR_OUT_FIELD_DESC = new TField("inOrOut", TType.I32, (short)3);
  ...
  public ScoreTradeQueryParam setTradeTime(String tradeTime) {
    this.tradeTime = tradeTime;
