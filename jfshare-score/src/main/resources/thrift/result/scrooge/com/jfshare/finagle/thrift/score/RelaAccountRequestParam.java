...
public class RelaAccountRequestParam implements TBase<RelaAccountRequestParam, RelaAccountRequestParam._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField TO_KEN_FIELD_DESC = new TField("ToKen", TType.STRING, (short)8);
  private static final TField EXCEED_TIME_FIELD_DESC = new TField("ExceedTime", TType.STRING, (short)9);
  ...
  public enum _Fields implements TFieldIdEnum {
    ...
    TO_KEN((short)8, "ToKen"),
    EXCEED_TIME((short)9, "ExceedTime");
  ...
  static {
    ...
    tmpMap.put(_Fields.OUT_CUST_ID, new FieldMetaData("OutCustID", TFieldRequirementType.DEFAULT,
      new FieldValueMetaData(TType.STRING)));
    tmpMap.put(_Fields.TO_KEN, new FieldMetaData("ToKen", TFieldRequirementType.DEFAULT,
      new FieldValueMetaData(TType.STRING)));
    tmpMap.put(_Fields.EXCEED_TIME, new FieldMetaData("ExceedTime", TFieldRequirementType.DEFAULT,
      new FieldValueMetaData(TType.STRING)));
  ...
  public RelaAccountRequestParam(RelaAccountRequestParam other) {
    ...
    if (other.isSetExceedTime()) {
      this.ExceedTime = other.ExceedTime;
    }
  }
  ...
  public RelaAccountRequestParam setExceedTime(String ExceedTime) {
    this.ExceedTime = ExceedTime;
    
    return this;
  }

  public void unsetExceedTime() {
    this.ExceedTime = null;
  }

  /** Returns true if field ExceedTime is set (has been asigned a value) and false otherwise */
  public boolean isSetExceedTime() {
    return this.ExceedTime != null;
  }

  public void setExceedTimeIsSet(boolean value) {
    if (!value) {
      this.ExceedTime = null;
    }
  }
  ...
  public boolean equals(RelaAccountRequestParam that) {
    ...
    boolean this_present_ExceedTime = true && this.isSetExceedTime();
    boolean that_present_ExceedTime = true && that.isSetExceedTime();
    if (this_present_ExceedTime || that_present_ExceedTime) {
      if (!(this_present_ExceedTime && that_present_ExceedTime))
        return false;
      if (!this.ExceedTime.equals(that.ExceedTime))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_ExceedTime = true && (isSetExceedTime());
    builder.append(present_ExceedTime);
    if (present_ExceedTime)
      builder.append(ExceedTime);
  ...
  public int compareTo(RelaAccountRequestParam other) {
    ...
    lastComparison = Boolean.valueOf(isSetExceedTime()).compareTo(typedOther.isSetExceedTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExceedTime()) {
      lastComparison = TBaseHelper.compareTo(this.ExceedTime, typedOther.ExceedTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void read(TProtocol iprot) throws TException {
    ...
    while (true)
    {
      ...
      switch (field.id) {
        ...
        case 9: // EXCEED_TIME
          if (field.type == TType.STRING) {
            this.ExceedTime = iprot.readString();
          } else {
            TProtocolUtil.skip(iprot, field.type);
          }
          break;
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.ExceedTime != null) {
      oprot.writeFieldBegin(EXCEED_TIME_FIELD_DESC);
      oprot.writeString(this.ExceedTime);
      oprot.writeFieldEnd();
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("ExceedTime:");
    if (this.ExceedTime == null) {
      sb.append("null");
    } else {
      sb.append(this.ExceedTime);
    }
    first = false;
    sb.append(")");
    return sb.toString();
