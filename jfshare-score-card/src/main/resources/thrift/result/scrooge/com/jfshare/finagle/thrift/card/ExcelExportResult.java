...
public class ExcelExportResult implements TBase<ExcelExportResult, ExcelExportResult._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("ExcelExportResult");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(ExcelExportResult.class, metaDataMap);
  }
   ...
   */
  public ExcelExportResult(ExcelExportResult other) {
  ...
  public ExcelExportResult deepCopy() {
    return new ExcelExportResult(this);
  }
  ...
  public ExcelExportResult setResult(com.jfshare.finagle.thrift.result.Result result) {
    this.result = result;
  ...
  public ExcelExportResult setPath(String path) {
    this.path = path;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ExcelExportResult)
      return this.equals((ExcelExportResult)that);
    return false;
  }

  public boolean equals(ExcelExportResult that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ExcelExportResult other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ExcelExportResult typedOther = (ExcelExportResult)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ExcelExportResult(");
    boolean first = true;
    sb.append("result:");
    if (this.result == null) {
      sb.append("null");
