...
public class Constants {
    ...
    /**  当前项目的zk 根节点*/
    public static final String ZK_POSTURL= "jfx_public_fastdfs";
    public static final String ZK_Fast_= "jfx_score_card_serv";
	//积分兑出天翼方地址
    ...
    //兑出积分成功状态
    public static final String CASHSUCCESS = "0000";
    //兑出积分成功消息
    public static final String CASHSUCCESSERRMSG = "积分发行成功";
	...
	public static final String REDIS_MOBILE_CASH = "redis:mobile:cash:";
	public static final String REDIS_USERID_CASH = "redis:userid:cash:";
