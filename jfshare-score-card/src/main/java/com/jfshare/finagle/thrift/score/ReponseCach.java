...
public class ReponseCach implements TBase<ReponseCach, ReponseCach._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("ReponseCach");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(ReponseCach.class, metaDataMap);
  }
   ...
   */
  public ReponseCach(ReponseCach other) {
  ...
  public ReponseCach deepCopy() {
    return new ReponseCach(this);
  }
  ...
  public ReponseCach setAppCode(String AppCode) {
    this.AppCode = AppCode;
  ...
  public ReponseCach setResponseDate(String ResponseDate) {
    this.ResponseDate = ResponseDate;
  ...
  public ReponseCach setSign(String Sign) {
    this.Sign = Sign;
  ...
  public ReponseCach setErrCode(String ErrCode) {
    this.ErrCode = ErrCode;
  ...
  public ReponseCach setErrMsg(String ErrMsg) {
    this.ErrMsg = ErrMsg;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReponseCach)
      return this.equals((ReponseCach)that);
    return false;
  }

  public boolean equals(ReponseCach that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ReponseCach other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ReponseCach typedOther = (ReponseCach)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReponseCach(");
    boolean first = true;
    sb.append("AppCode:");
    if (this.AppCode == null) {
      sb.append("null");
