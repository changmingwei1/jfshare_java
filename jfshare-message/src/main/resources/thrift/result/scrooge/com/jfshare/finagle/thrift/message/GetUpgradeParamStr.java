...
public class GetUpgradeParamStr implements TBase<GetUpgradeParamStr, GetUpgradeParamStr._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("GetUpgradeParamStr");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(GetUpgradeParamStr.class, metaDataMap);
  }


  public GetUpgradeParamStr() {
  }
   ...
   */
  public GetUpgradeParamStr(GetUpgradeParamStr other) {
  ...
  public GetUpgradeParamStr deepCopy() {
    return new GetUpgradeParamStr(this);
  }
  ...
  public GetUpgradeParamStr setAppType(int appType) {
    this.appType = appType;
    setAppTypeIsSet(true);
  ...
  public GetUpgradeParamStr setVersion(String version) {
    this.version = version;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetUpgradeParamStr)
      return this.equals((GetUpgradeParamStr)that);
    return false;
  }

  public boolean equals(GetUpgradeParamStr that) {
    if (that == null)
      return false;
  ...
  public int compareTo(GetUpgradeParamStr other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetUpgradeParamStr typedOther = (GetUpgradeParamStr)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetUpgradeParamStr(");
    boolean first = true;
    sb.append("appType:");
