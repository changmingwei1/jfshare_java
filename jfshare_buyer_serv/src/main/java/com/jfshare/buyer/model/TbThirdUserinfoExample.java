...
public class TbThirdUserinfoExample {
    ...
    protected abstract static class GeneratedCriteria {
        protected List<Criterion> ext2Criteria;
        ...
        protected GeneratedCriteria() {
            ...
            ext2Criteria = new ArrayList<Criterion>();
            createTimeCriteria = new ArrayList<Criterion>();
            updateTimeCriteria = new ArrayList<Criterion>();
        }

        public List<Criterion> getExt2Criteria() {
            return ext2Criteria;
        }

        protected void addExt2Criterion(String condition, Object value, String property) {
            if (value == null) {
                throw new RuntimeException("Value for " + property + " cannot be null");
            }
            ext2Criteria.add(new Criterion(condition, value, "com.jfshare.mybatis.typehandler.JodaDateTime2TimestampTypeHandler"));
            allCriteria = null;
        }

        protected void addExt2Criterion(String condition, DateTime value1, DateTime value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            ext2Criteria.add(new Criterion(condition, value1, value2, "com.jfshare.mybatis.typehandler.JodaDateTime2TimestampTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addUpdateTimeCriterion(String condition, Object value, String property) {
            ...
            updateTimeCriteria.add(new Criterion(condition, value, "com.jfshare.mybatis.typehandler.JodaDateTime2TimestampTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addUpdateTimeCriterion(String condition, DateTime value1, DateTime value2, String property) {
            ...
            updateTimeCriteria.add(new Criterion(condition, value1, value2, "com.jfshare.mybatis.typehandler.JodaDateTime2TimestampTypeHandler"));
            allCriteria = null;
        }
        ...
        public List<Criterion> getAllCriteria() {
            if (allCriteria == null) {
                ...
                allCriteria.addAll(ext2Criteria);
        ...
        public Criteria andExt2EqualTo(DateTime value) {
            addExt2Criterion("ext2 =", value, "ext2");
            return (Criteria) this;
        }

        public Criteria andExt2NotEqualTo(DateTime value) {
            addExt2Criterion("ext2 <>", value, "ext2");
            return (Criteria) this;
        }

        public Criteria andExt2GreaterThan(DateTime value) {
            addExt2Criterion("ext2 >", value, "ext2");
            return (Criteria) this;
        }

        public Criteria andExt2GreaterThanOrEqualTo(DateTime value) {
            addExt2Criterion("ext2 >=", value, "ext2");
            return (Criteria) this;
        }

        public Criteria andExt2LessThan(DateTime value) {
            addExt2Criterion("ext2 <", value, "ext2");
            return (Criteria) this;
        }

        public Criteria andExt2LessThanOrEqualTo(DateTime value) {
            addExt2Criterion("ext2 <=", value, "ext2");
            return (Criteria) this;
        }

        public Criteria andExt2In(List<DateTime> values) {
            addExt2Criterion("ext2 in", values, "ext2");
            return (Criteria) this;
        }

        public Criteria andExt2NotIn(List<DateTime> values) {
            addExt2Criterion("ext2 not in", values, "ext2");
            return (Criteria) this;
        }

        public Criteria andExt2Between(DateTime value1, DateTime value2) {
            addExt2Criterion("ext2 between", value1, value2, "ext2");
            return (Criteria) this;
        }

        public Criteria andExt2NotBetween(DateTime value1, DateTime value2) {
            addExt2Criterion("ext2 not between", value1, value2, "ext2");
            return (Criteria) this;
        }
